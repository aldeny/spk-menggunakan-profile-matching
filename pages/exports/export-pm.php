            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-5">
                        <h1 class="h3 mb-0 text-gray-800">Export Data Profile Matching</h1>
                    </div>
                    ...
                    <form action="" method="GET">
                        <div class="row">
                            ...
                            if (isset($_GET['tahun'])) {
                                $tahun = $_GET['tahun'];
                                $query = "SELECT pm.n_total_ipa, pm.n_total_ips, st.* 
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <a href="export-pm.php" class="btn btn-sm btn-dark text-white">Reset</a>
                                    <a href="export-pm-excel.php?tahun=<?= $tahun ?>" class="btn btn-sm btn-success text-white"><i class="bi bi-file-earmark-spreadsheet"></i>
                                        Export Excel</a>
                                    <a href="export-pm-pdf.php?tahun=<?= $tahun ?>" class="btn btn-sm btn-dark text-white" target="_blank"><i class="bi bi-filetype-pdf"></i>
                                        Export Pdf</a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $data['n_total_ipa'] ?></td>
                                                <td><?= $data['n_total_ips'] ?></td>
                                                <td>
                                                    <?php
