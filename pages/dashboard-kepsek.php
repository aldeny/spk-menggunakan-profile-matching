...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard-kepsek.php">
            ...
            <li class="nav-item active">
                <a class="nav-link" <?php if ($_SESSION['role'] == 1) { ?> href="dashboard-kepsek.php" <?php } else { ?> href="dashboard.php" <?php } ?> href="dashboard.php">
